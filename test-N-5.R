...
model <- h2o.deeplearning(x = 2:5236, y = 1,train_h2o.hex, activation = "RectifierWithDropout", distribution = "bernoulli", hidden = c(1000, 2000, 1000), input_dropout_ratio = 0.2, l1 = 1e-5, epochs = 10000, loss="CrossEntropy") 
...
write.csv(yhat_test,file="E:/rcode/output_test-N-5.csv",row.names=F,quote=F)
