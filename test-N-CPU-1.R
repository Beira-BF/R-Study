...
model <- h2o.deeplearning(x = 2:5236, y = 1,train_h2o.hex, activation = "Maxout", distribution = "bernoulli", hidden = c(1000, 2000, 1000), epochs = 10000, loss="CrossEntropy", nfolds = 5) 
...
write.csv(yhat_test,file="/home/QSAR/Rcode/output_test-CPU-1.csv",row.names=F,quote=F)
