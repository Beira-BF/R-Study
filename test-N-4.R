...
pathToFolder = "/home/QSAR/Rcode/tr.csv"
...
model <- h2o.deeplearning(x = 2:5236, y = 1,train_h2o.hex, activation = "RectifierWithDropout", distribution = "AUTO", hidden = c(1000,2000,3000,2000,1000), input_dropout_ratio = 0.2, epochs = 10000, loss="CrossEntropy", nfolds = 5) 

yhat_train <- h2o.predict(model, train_h2o.hex)$predict
yhat_train <- as.data.frame(yhat_train)


pathToFolder2 = "/home/QSAR/Rcode/tst.csv"
...
write.csv(yhat_test,file="/home/QSAR/Rcode/output_test-N-4.csv",row.names=F,quote=F)
